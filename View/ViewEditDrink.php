        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="?page=EditDrink" class="active-menu"><i class="fa fa-sitemap"></i>Edit Drink</a>
                    </li>
                 ...
                 <div class="col-md-3">
                     <tr>
                         <td colspan="4" align="center" >
                             <input type="submit" name="btnEditDrink" class="btn btn-success" value="Edit/Insert">
              ...
              <?php 
                if(isset($data) && $data != null)
                {
                    foreach ($data as $key) {
                        ...
                        <td>{$key['price']}</td>
                        <td>{$key['image']}</td>
                        <td><a href='?page=EditDrink&Drink=".$key['name']."'>
                                <i class='fa fa-user'></i>Edit</a></td>
                        <td><a href='?page=EditDrink&Drink=".$key['name']."&delete=1' onclick='return confirm(\"Are you sure to delete it ?\");'>
